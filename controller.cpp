...
void Controller::PINV(vec_wrench& wrench, Mat_actuation& A, vec_current& I_output){
    // Use this instead of the overloaded funcion
...
void Controller::WPINV(vec_wrench& wrench, Mat_actuation& A, std::vector<uint>& _available_coils, vec_current& I_old, uint null_space, vec_temp_C& T,vec_current& I_output){

};
// void Controller::RWPINV(vec_wrench& wrench, Mat_actuation& A, double n, vec_current* I_MaxHigh, vec_current* I_MaxLow, current* I_pow, vec_temp_C* T, vec_current* I_output){
